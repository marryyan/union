...
<script>
  import { postStoreStoretaxtempInfo, postStoreStoretaxtempUpdate } from '@/http/api'
  export default {
    data() {
      return {
        formLabelAlign: {
    ...
    methods:{
      ...
      postStoreStoretaxtempInfo(){
        ...
        postStoreStoretaxtempInfo(data).then(res => {
      ...
      postStoreStoretaxtempUpdate(){
        ...
        postStoreStoretaxtempUpdate(data).then(res => {
          if (res.status == 200) {
